...
"""
jishaku.paginators (shim for hashcord.py 2.0.0)
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
class PaginatorInterface(ui.View):  # pylint: disable=too-many-instance-attributes
    ...
    async def interaction_check(self, interaction: hashcord.Interaction):
    ...
    @ui.button(label="1 \u200b \N{BLACK LEFT-POINTING DOUBLE TRIANGLE WITH VERTICAL BAR}", style=hashcord.ButtonStyle.secondary)
    async def button_start(self, button: ui.Button, interaction: hashcord.Interaction):  # pylint: disable=unused-argument
    ...
    @ui.button(label="\N{BLACK LEFT-POINTING TRIANGLE}", style=hashcord.ButtonStyle.secondary)
    async def button_previous(self, button: ui.Button, interaction: hashcord.Interaction):  # pylint: disable=unused-argument
    ...
    @ui.button(label="1", style=hashcord.ButtonStyle.primary)
    async def button_current(self, button: ui.Button, interaction: hashcord.Interaction):  # pylint: disable=unused-argument
        """Button to refresh the interface"""

        self.update_view()
        await interaction.response.edit_message(**self.send_kwargs)

    @ui.button(label="\N{BLACK RIGHT-POINTING TRIANGLE}", style=hashcord.ButtonStyle.secondary)
    async def button_next(self, button: ui.Button, interaction: hashcord.Interaction):  # pylint: disable=unused-argument
    ...
    @ui.button(label="\N{BLACK RIGHT-POINTING DOUBLE TRIANGLE WITH VERTICAL BAR} \u200b 1", style=hashcord.ButtonStyle.secondary)
    async def button_last(self, button: ui.Button, interaction: hashcord.Interaction):  # pylint: disable=unused-argument
    ...
    @ui.button(label="\N{BLACK SQUARE FOR STOP} \u200b Close paginator", style=hashcord.ButtonStyle.danger)
    async def button_close(self, button: ui.Button, interaction: hashcord.Interaction):  # pylint: disable=unused-argument
